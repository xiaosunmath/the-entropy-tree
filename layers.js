        ...
        "恒星质量": {
            content: [ ["infobox","introBox"],
               "main-display","prestige-button",["display-text",
                function() {return '你有' + format(player.c.mass) + '恒星质量,将天体层级的两个购买项效果在软上限后变为原来的' + format(player.c.mass.add(1).log(10).div(3).add(1)) + '次方'},
    ...
    buyables: {
        11: {
            ...
            effect(){
                ...
                effe = effe.pow(player.c.mass.add(1).log(10).div(3).add(1))
                return effe
            },
        },
        12: {
